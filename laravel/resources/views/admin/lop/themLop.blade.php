        ...
        <div class="u-content">
            <div class="u-body">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ url('importLop') }}" accept-charset="utf-8" enctype="multipart/form-data">
                        ...
                        <form action="{{ route('lop.store') }}" method="POST">
                            ...
                            <div class="button-create">
                                <button style="margin-right: 5px" type="submit" class="btn btn-success">Thêm Lớp</button>
