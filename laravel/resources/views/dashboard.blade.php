        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light menu-header">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="right-menu-header">
                    ...
                    <button id="btnLogin" onclick="window.location='{{ route('login') }}'">Đăng nhập</button>
                </div>
            </div>
        </nav>
    ...
    <div class="main">
            ...
            <div class="card-group">
                <div class="card-item">
                    <div class="card text-white">
                        <img src="{{ URL::to('/') }}/img/img1.png" class="card-img-top card-image" alt="image">
                ...
                <div class="card-item">
                    <div class="card text-white">
                        <img src="{{ URL::to('/') }}/img/img2.png" class="card-img-top card-image" alt="image">
                        <div class="card-img-overlay">
                ...
                <div class="card-item">
                    <div class="card text-white">
                        <img src="{{ URL::to('/') }}/img/img3.png" class="card-img-top" alt="image">
                        <div class="card-img-overlay">
                ...
                <div class="card-item">
                    <div class="card text-white">
                        <img src="{{ URL::to('/') }}/img/img4.png" class="card-img-top" alt="image">
                        <div class="card-img-overlay">
                ...
                <div class="card-item">
                    <div class="card text-white">
                        <img src="{{ URL::to('/') }}/img/img5.png" class="card-img-top" alt="image">
                        <div class="card-img-overlay">
                ...
                <div class="card-item">
                    <div class="card text-white">
                        <img src="{{ URL::to('/') }}/img/img6.png" class="card-img-top" alt="image">
                        <div class="card-img-overlay">
                ...
                <div class="card-item">
                    <div class="card text-white">
                        <img src="{{ URL::to('/') }}/img/img7.png" class="card-img-top" alt="image">
                        <div class="card-img-overlay">
                ...
                <div class="card-item">
                    <div class="card text-white">
                        <img src="{{ URL::to('/') }}/img/img8.png" class="card-img-top" alt="image">
                        <div class="card-img-overlay">
        ...
        <div class="ktdt">
            ...
            <div class="card-group">
                ...
                <div class="card-item">
                    <div class="card text-white">
                        <img src="{{ URL::to('/') }}/img/img4.png" class="card-img-top card-image" alt="image">
                        <div class="card-img-overlay">
                ...
                <div class="card-item">
                    <div class="card text-white">
                        <img src="{{ URL::to('/') }}/img/img2.png" class="card-img-top" alt="image">
                        <div class="card-img-overlay">
