...
<head>
    ...
    <link rel="stylesheet" href="../css/style-ketqua.css">
...
<body>
    <div class="header">
        <nav class="navbar navbar-expand-lg navbar-light bg-light menu-header">
            <a class="navbar-brand logo-header" href="#">
                <img src="../../assets/logo.png" width="27px" height="45px" style="margin-left: 20px; margin-right: 26px;" alt="logo" />
            </a>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="right-menu-header">
                    ...
                    <button id="btnLogin" onclick="login()">Đăng xuất</button>
                    <script>
        ...
        <div class="info-header">
            <div class="info-img">
                <img src="https://mdbootstrap.com/img/new/avatars/2.jpg" class="rounded-circle" style="width: 150px;" alt="" />
            </div>
    ...
    <nav class="navbar order-last order-lg-0 menu-navbar">
        <ul>
            <li><a class="nav-link" href="./dangky.php">Đăng ký học phần</span></a></li>
            <li><a class="nav-link active" href="./ketqua.php"><span class="style-active">Kết quả đăng ký</a></li>
            <li><a class="nav-link" href="./lichsu.php">Lịch sử đăng ký</a></li>
        </ul>
    </nav>
    <div class="main">
        <div style="width: 100%;">
            <button style="width: 100%; background-color: #f2f4f6; color: #000000; text-align: start; border: 1px solid #979797; font-size: 20px; font-family: 'Nunito';" type="button" class="btn btn-primary" data-toggle="collapse" data-target="#demo1">NĂM HỌC 2020-2021<i style="padding-left: 84%" class="fas fa-caret-left"></i></button>
