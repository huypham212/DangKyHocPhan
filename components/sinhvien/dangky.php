    ...
    <div class="main">
        <div class="card">
            <div class="card-header">
                <h6><img src="../../assets/Vector.png" width="15px" height="15px" alt="logo" /> Thông tin đăng ký</h6>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-6">
        ...
        <div class="card">
            <div class="card-header">
                <h6><img src="../../assets/Vector.png" width="15px" height="15px" alt="logo" /> Chương trình đào tạo</h6>
            </div>
            <div class="card-body">
                <div>
        ...
        <div class="card">
            <div class="card-header">
                <h6><img src="../../assets/Vector.png" width="15px" height="15px" alt="logo" /> Kết quả đăng ký học phần</h6>
            </div>
            <div class="card-body">
                <div>
